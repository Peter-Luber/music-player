...
function updateTime() {
  var currentSeconds =
    (Math.floor(activeSong.currentTime % 60) < 10 ? "0" : "") +
    Math.floor(activeSong.currentTime % 60);
  ...
  var percentageOfSlider =
    document.getElementById("songSlider").offsetWidth * percentageOfSong;
